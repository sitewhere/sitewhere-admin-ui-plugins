...
var DeviceRegistrationPluginvue_type_script_lang_ts_DeviceRegsitrationPlugin = /** @class */ (function (_super) {
    ...
    DeviceRegsitrationPlugin.prototype.onAssetTokenUpdated = function (updated) {
    ...
    DeviceRegsitrationPlugin.prototype.loadAssets = function () {
        return __awaiter(this, void 0, void 0, function () {
            var criteria, format, response, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        format = {};
                        return [4 /*yield*/, Object(external_sitewhere_ide_common_["listAssets"])(this.$store, criteria, format)];
                    case 1:
                        response = _a.sent();
                    ...
                    case 2:
                        err_4 = _a.sent();
                        Object(external_sitewhere_ide_common_["showError"])(this, err_4);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
    ...
    __decorate([
        Object(external_vue_property_decorator_["Watch"])("assetToken")
    ], DeviceRegsitrationPlugin.prototype, "onAssetTokenUpdated", null);
...
var DeviceRegistrationPlugin_component = normalizeComponent(
  ...
  DeviceRegistrationPluginvue_type_template_id_621ef342_render,
  DeviceRegistrationPluginvue_type_template_id_621ef342_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"49d4c8cc-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/plugins/tenantengines/outboundconnectors/mqtt/MqttConnectionFields.vue?vue&type=template&id=10ce0292&
var MqttConnectionFieldsvue_type_template_id_10ce0292_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('dialog-form',[_c('v-flex',{attrs:{"xs2":""}},[_c('form-select',{attrs:{"items":_vm.protocols,"title":"Choose connection protocol","label":"Protocol","item-text":"text","item-value":"value","icon":"lock"},model:{value:(_vm.protocol),callback:function ($$v) {_vm.protocol=$$v},expression:"protocol"}})],1),_c('v-flex',{attrs:{"xs8":""}},[_c('form-text',{staticClass:"ml-3 mr-3",attrs:{"required":"","label":"Hostname","title":"MQTT broker hostname.","icon":"router"},model:{value:(_vm.hostname),callback:function ($$v) {_vm.hostname=$$v},expression:"hostname"}},[(!_vm.$v.hostname.required && _vm.$v.$dirty)?_c('span',[_vm._v("Hostname is required.")]):_vm._e()])],1),_c('v-flex',{attrs:{"xs2":""}},[_c('form-text',{attrs:{"required":"","label":"Port","title":"MQTT broker port.","type":"number"},model:{value:(_vm.port),callback:function ($$v) {_vm.port=$$v},expression:"port"}},[(!_vm.$v.port.required && _vm.$v.$dirty)?_c('span',[_vm._v("Required.")]):_vm._e()])],1),_c('v-flex',{attrs:{"xs12":""}},[_c('form-text',{staticClass:"mb-4",attrs:{"required":"","label":"Topic","title":"MQTT topic where events will be forwarded.","icon":"arrow_forward"},model:{value:(_vm.outboundTopic),callback:function ($$v) {_vm.outboundTopic=$$v},expression:"outboundTopic"}},[(!_vm.$v.outboundTopic.required && _vm.$v.$dirty)?_c('span',[_vm._v("Outbound topic is required.")]):_vm._e()])],1)],1)}
var MqttConnectionFieldsvue_type_template_id_10ce0292_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/plugins/tenantengines/outboundconnectors/mqtt/MqttConnectionFields.vue?vue&type=template&id=10ce0292&
...
var outboundconnectors_mqtt_MqttConnectionFields_component = normalizeComponent(
  ...
  MqttConnectionFieldsvue_type_template_id_10ce0292_render,
  MqttConnectionFieldsvue_type_template_id_10ce0292_staticRenderFns,
  false,
  null,
  null,
  null
